...
final class CustomGroundArmorstand extends EntityArmorStand implements PetBlock {
    ...
    private EntityHuman hasHumanPassenger() {
        if (this.passengers != null) {
            for (final net.minecraft.server.v1_9_R1.Entity entity : this.passengers) {
        ...
        if (this.isSpecial) {
            if (this.hasHumanPassenger() != null) {
                if (this.petMeta.getEngine().getRideType() == RideType.RUNNING) {
                    ...
                    sideMot = this.hasHumanPassenger().bd * 0.5F;
                    forMot = this.hasHumanPassenger().be;
                    if (forMot <= 0.0F) {
                        forMot *= 0.25F;
                    }
                    ...
                    final float side = this.hasHumanPassenger().bd * 0.5F;
                    final float forw = this.hasHumanPassenger().be;
